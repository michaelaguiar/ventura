            ...
            Forms\Components\Section::make('Photos')->schema([
                Forms\Components\Placeholder::make('existing_photos')
                    ...
                    ->content(function ($record) {
                        ...
                        foreach ($record->photos as $index => $photo) {
                            ...
                            $fileInfo = $record->getPhotoFileInfo($index) ?? [];
                            $fileName = $fileInfo['name'] ?? 'Unknown file';
                            $fileSizeFormatted =
                                $fileInfo['size_formatted'] ?? 'Unknown size';
                        ...
                        $photosHtml .= '<div class="flex flex-col space-y-2">';
                        $photosHtml .=
                        ...
                        $photosHtml .= '<span>Press \'D\' to download</span>';
                        $photosHtml .= '<span>•</span>';
                        $photosHtml .= '<span>Press \'Esc\' to close</span>';
                        $photosHtml .= '</div>';
                        $photosHtml .= '</div>';
                        $photosHtml .=
                        ...
                        $photosHtml .= '<script>';
                        $photosHtml .= '(function() {';
                        $photosHtml .= 'let currentMaintenancePhotoIndex = 0;';
                        $photosHtml .= 'let photoToDelete = null;';
                        $photosHtml .=
                            'const maintenancePhotoUrls = '.$photoUrls.';';
                        $photosHtml .=
                            'const maintenanceRequestId = '.$record->id.';';
                        ...
                        $photosHtml .= 'headers: {';
                        $photosHtml .= '"X-Requested-With": "XMLHttpRequest",';
                        $photosHtml .= '"Content-Type": "application/json",';
                        $photosHtml .=
                        ...
                        $photosHtml .= 'window.hideImageLoader = function() {';
                        $photosHtml .=
                            'const loader = document.getElementById("maintenanceModalLoader");';
                        $photosHtml .=
                            'const image = document.getElementById("maintenanceModalImage");';
                        ...
                        return new \Illuminate\Support\HtmlString($photosHtml);
                    })
                    ->visible(
                ...
                Forms\Components\FileUpload::make('photos')
                    ...
                    ->extraAttributes([
                        ...
                        'x-on:livewire-upload-finish' => 'uploading = false; setTimeout(() => window.location.reload(), 1000)',
                    ])
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->color(
                        fn (MaintenanceRequestStatus $state): string => match (
                            ...
                            MaintenanceRequestStatus::REQUIRES_APPROVAL => 'warning',
                            default => 'gray',
                        }
                    ),
