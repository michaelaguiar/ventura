...
class BookAmenity extends Component
{
    ...
    protected $messages = [
        ...
        "formData.booking_date.after_or_equal" =>
        ...
        "formData.contact_phone.max" =>
            "Contact phone must be less than 20 characters",
        "formData.contact_email.required" => "Contact email is required",
        "formData.contact_email.email" => "Please enter a valid email address",
        "formData.contact_email.max" =>
            "Contact email must be less than 255 characters",
        "formData.special_requests.max" =>
