    ...
    <div class="max-w-screen-xl w-full">
        ...
        <div class="hidden lg:flex relative min-h-[750px]" style="">
            ...
            <div class="flex flex-col px-8 pt-24 pb-6 z-2">
                <h1 class="text-2xl font-bold text-gray-800 mb-8">Submit Maintenance Request</h1>
                ...
                <!-- Form -->
                <form wire:submit="addMaintenanceRequest" class="space-y-4 max-w-sm">
                    <!-- Title -->
                    <div>
                    ...
                    <!-- Photos Upload -->
                    <div>
                        <label for="requestPhotos" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            PHOTOS (OPTIONAL)
                        </label>
                        <div class="relative">
                            <input
            ...
            <!-- Right Side - Maintenance Requests List -->
            <div class="w-[500px] px-8 pt-24 pb-6 max-w-md z-2 ml-auto">
                ...
                <div class="grid grid-cols-1 gap-2">
                    @forelse(array_slice($maintenanceRequests, 0, 6) as $request)
                        <div class="bg-gray-100 rounded-lg p-3 hover:bg-gray-200 transition-colors max-w-sm cursor-pointer" wire:click="openDetailsModal({{ $request['id'] }})">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-800 mb-1 text-sm">{{ $request['title'] }}</h4>
                    ...
                    @empty
                        <div class="text-center py-8">
                            ...
                            <p class="text-sm text-gray-400">Submit your first request to get started</p>
                        </div>
                    @endforelse
                </div>
        ...
        <div class="lg:hidden">
            ...
            <div class="px-8 pt-12 pb-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Submit Maintenance Request</h1>
                ...
                <!-- Form -->
                <form wire:submit="addMaintenanceRequest" class="space-y-4 max-w-sm mx-auto">
                    <!-- Title -->
                    <div>
                        <label for="requestTitleMobile" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            TITLE
                        </label>
                        <input
                            type="text"
                            id="requestTitleMobile"
                            wire:model="formData.title"
                            placeholder="Brief description of the issue"
                            class="w-full px-4 py-3 border border-[#72d0df] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 bg-white"
                            required
                    ...
                    <!-- Description -->
                    <div>
                        <label for="requestDescriptionMobile" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            DESCRIPTION
                        </label>
                        <textarea
                            id="requestDescriptionMobile"
                            wire:model="formData.description"
                            placeholder="Detailed description of the maintenance issue"
                            rows="4"
                            class="w-full px-4 py-3 border border-[#72d0df] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 bg-white resize-none"
                    ...
                    <!-- Priority -->
                    <div>
                        <label for="requestPriorityMobile" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            PRIORITY
                        </label>
                        <select
                            id="requestPriorityMobile"
                            wire:model="formData.priority"
                            class="w-full px-4 py-3 border border-[#72d0df] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 bg-white"
                            required
                        >
                    ...
                    <!-- Category -->
                    <div>
                        <label for="requestCategoryMobile" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            CATEGORY
                        </label>
                        <select
                            id="requestCategoryMobile"
                            wire:model="formData.category"
                            class="w-full px-4 py-3 border border-[#72d0df] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 bg-white"
                            required
                        >
                    ...
                    <!-- Photos Upload -->
                    <div>
                        <label for="requestPhotosMobile" class="block text-xs font-bold text-gray-700 mb-2 tracking-wider">
                            PHOTOS (OPTIONAL)
                        </label>
                        <input
                            type="file"
                            id="requestPhotosMobile"
                            wire:model="photos"
                            accept="image/*"
                            multiple
            ...
            <div class="px-8 pb-6">
                ...
                <div class="space-y-3">
                    @forelse($maintenanceRequests as $request)
                        <div class="bg-gray-100 rounded-lg p-4 hover:bg-gray-200 transition-colors cursor-pointer" wire:click="openDetailsModal({{ $request['id'] }})">
                            <div class="flex items-start space-x-3">
                                <div class="flex-shrink-0">
                                    @if(count($request['photos']) > 0)
                                        <img src="{{ Storage::url($request['photos'][0]) }}" alt="Request Photo" class="w-12 h-12 rounded-lg object-cover">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-800 mb-1">{{ $request['title'] }}</h4>
